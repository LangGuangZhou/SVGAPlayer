...
@objcMembers
public final class SVGAVideoSpriteEntity: NSObject {

    // MARK: - Public (ObjC-friendly)
    public private(set) var imageKey: String?
    public private(set) var frames: [SVGAVideoSpriteFrameEntity] = []
    public private(set) var matteKey: String?
    ...
    public func requestLayer(withBitmap bitmap: UIImage?) -> SVGAContentLayer? {
