...
public final class SVGAVideoEntity: NSObject {
    ...
    public var videoSize: CGSize = CGSize(width: 100, height: 100)
    public private(set) var FPS: Int = 20
    public private(set) var frames: Int = 0
    public private(set) var images: [String: UIImage] = [:]
    private(set) var audiosData: [String: Data] = [:]
    public private(set) var sprites: [SVGAVideoSpriteEntity] = []
    ...
    @objc(readCache:)
    public class func readCache(_ cacheKey: String) -> SVGAVideoEntity? {
    ...
    @objc(removeCache:)
    public class func removeCache(_ cacheKey: String) {
