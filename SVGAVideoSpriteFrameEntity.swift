...
@objcMembers
public class SVGAVideoSpriteFrameEntity: NSObject {

    // MARK: - Public Properties (ObjC-friendly)

    public private(set) var alpha: CGFloat = 0.0
    public var transform: CGAffineTransform = .init(a: 1, b: 0, c: 0, d: 1, tx: 0, ty: 0)
    public var layout: CGRect = .zero
    public var nx: CGFloat = 0.0
    public var ny: CGFloat = 0.0
